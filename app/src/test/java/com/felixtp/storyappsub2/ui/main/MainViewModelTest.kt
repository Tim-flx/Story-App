...
import com.felixtp.storyappsub2.DataDummy
import com.felixtp.storyappsub2.MainDispatcherRule
import com.felixtp.storyappsub2.data.UserRepository
import com.felixtp.storyappsub2.data.remote.response.ListStoryItem
import com.felixtp.storyappsub2.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getStory(token)).thenReturn(expectedStory)
